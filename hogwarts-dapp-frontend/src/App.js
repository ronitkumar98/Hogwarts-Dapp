...
import RandomHouseAssignment from "./artifacts/RandomHouseAssignment.sol/RandomHouseAssignment.json"; 
import HogwartsNFT from "./artifacts/HogwartsNFT.sol/HogwartsNFT.json"; 
    ...
    if (started) {
	    if (window.ethereum) {
	      ...
	      window.ethereum.enable().then((accounts) => {
	        setAccount(accounts[0]);
					const hogwartsAddress = "0x65e1bB821173258dF7703b3E7c0104Efb4F69e77";
	        const randomHouseAddress = "0xC092E57433f8f00ecA33656A448F6Bb203a3c6Df";
